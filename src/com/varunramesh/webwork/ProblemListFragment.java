...
/**
 * A list fragment representing a list of Problems. This fragment also supports
...
public class ProblemListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<ProblemContent.Problem>(getActivity(),
				layout,
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(ProblemContent.ITEMS.get(position).id);
	}
